 ...
 *
 * These describe the shape of the data that flows between the mock API
 * (`@pigeon/api`) and the dashboard (`@pigeon/web`). Swap the mock API for a
 * real backend later — as long as it satisfies these types, the UI won't care.
 */
